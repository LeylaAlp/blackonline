<?php $__env->startSection('title','Urun Yönetimi'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                ...
                                <form class="form-header" action="<?php echo e(route('yonetim.urun')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <input class="au-input au-input--xl" type="text" name="aranan" value="<?php echo e(old('aranan')); ?>" placeholder="Ürün Adı Ara.." />
                                    <button class="au-btn--submit" type="submit">
                                        <i class="zmdi zmdi-search"></i>
                                    </button>
                                    <a class="au-btn--submit" type="button" href="<?php echo e(route('yonetim.urun')); ?>">
                                            <span class="btn-outline-danger">  Temizle </span>
                                        </a>

                                </form>

                                <a href="<?php echo e(route('yonetim.urun.yeni')); ?>">
                                ...
                                <table class="table table-borderless table-data3">
                                    ...
                                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img style="height:80px; width:100px;" src="<?php echo e($entry->detay->urun_resmi!=null ?
                                            ...
                                            <td><?php echo e($entry->fiyati); ?> ₺</td>
                                            <td><?php echo e($entry->olusturulma_tarihi->isoFormat('LLLL')); ?></td>

                                            <td>
                                                <a href="<?php echo e(route('yonetim.urun.duzenle',$entry->id)); ?>"><span
...
<?php echo $__env->make('yonetim.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\AppServ\www\Project\resources\views/yonetim/urun/index.blade.php ENDPATH**/ ?>