...
Route::post('/siparisler', 'OdemeController@odemeyap')->name('odemeyap')->middleware('auth');
...
Route::get('/siparisler', 'SiparisController@index')->name('siparisler')->middleware('auth');
